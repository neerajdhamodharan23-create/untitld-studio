  ...
  return (
    <section id="contact" className="px-4 sm:px-6 lg:px-10 py-16 sm:py-20 lg:py-28">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6">
          ...
          <Reveal delay={100}>
            ...
            <p className="text-base text-fg/65 font-body font-light leading-relaxed mb-auto pb-12 max-w-md">
            ...
            <div className="card-raised p-7 mt-auto">
              ...
              <p className="text-[15px] text-fg/80 font-body font-light leading-relaxed mb-6">
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-rule">
                ...
                <div>
                  <p className="text-sm text-fg font-body">Neeraj D.</p>
                  <p className="text-[11px] tracking-widest uppercase text-fg/55 font-body font-light">
                    Founder of UNTITLD
                  </p>
                </div>
              </div>
          ...
          <Reveal delay={200}>
            ...
            {sent ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-20">
                ...
                <h3 className="font-display text-3xl tracking-wide uppercase text-fg mb-3">
                  Message sent
                </h3>
                <p className="text-sm text-fg/55 font-body font-light max-w-xs">
      ...
      <style>{`
        ...
        .form-input::placeholder { color: color-mix(in oklab, var(--fg) 35%, transparent); }
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label className="block">
      <span className="block text-[11px] tracking-widest uppercase text-fg/55 font-body mb-2">
        {label}
      </span>
      {children}
    </label>
